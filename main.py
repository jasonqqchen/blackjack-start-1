...
import random
from replit import clear # from Module import function
from art import logo

user_winning_times = 0
...
def play_game():
    global user_winning_times
    global computer_winning_times 
    print(logo)
    user_cards = []
    computer_cards = []
    for i in range(2):
    ...
    print(f"Comnputer final cards:{computer_cards}, final score:{computer_score}")

user_continue = input("Do you want to play a game of Black Jack?Type 'y' or 'n': " )

while user_continue == "y":
    clear()
    play_game()
    print(f"computer wins {computer_winning_times} and user win {user_winning_times}")
    user_continue = input("Do you want to play a game of Black Jack?Type 'y' or 'n': " )